...
VS_OUTPUT TheVertexShader( VS_INPUT input )
{
    VS_OUTPUT output;
...
float4 ThePixelShader( VS_OUTPUT input ) : COLOR0
{    
	...
	ambLightColor.rgb = AmbientLightColor.rgb * environmentColor.rgb;
    
    // return the combined result.
    return float4( (diffuse.rgb + ambLightColor.rgb) * diffuseTexture.rgb + 
