...
namespace RobotGameData.Utility
{
	internal static class XNA
	{
		...
		public static ModelMesh CreateModelMesh(List<ModelMeshPart> parts)
		{
			...
			return (ModelMesh)constructorInfo.Invoke(new object[] { FrameworkCore.GraphicsDevice, parts });
		}
		...
		public static Model CreateModel(List<ModelBone> bones, List<ModelMesh> meshes)
		{
			...
			return (Model)constructorInfo.Invoke(new object[] {
				FrameworkCore.GraphicsDevice,
				bones,
				meshes
			});
#else
			return new Model(FrameworkCore.GraphicsDevice, bones, meshes);
#endif
		}
